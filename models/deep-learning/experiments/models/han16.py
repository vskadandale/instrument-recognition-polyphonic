...
"""
This code contains model specifications for han16 model along with a function to compute mel-spectrograms for data preprocessing.
This model needs to be used with TensorFlow backend.
A large part of this code is taken from https://github.com/Veleslavia/EUSIPCO2017/blob/master/experiments/models/han16.py
